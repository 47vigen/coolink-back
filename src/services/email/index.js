                ...
                <div style="background-color: transparent">
                  ...
                  >
                    <div style="border-collapse: collapse; display: table; width: 100%; background-color: #f1f1f1">
                        ...
                        <div class="col_cont" style="width: 100% !important">
                          ...
                          >
                            ...
                            <div align="center" class="img-container center autowidth" style="padding-right: 16px; padding-left: 16px">
                              ...
                              <a href="https://coolink.ir" style="outline: none" tabindex="-1" target="_blank"
                                ><img
                                  align="center"
                                  alt="coolink"
                                  border="0"
                                  class="center autowidth"
                                  src="https://coolink.ir/images/coolink-logo.png"
                                  style="
                      ...
                      <!--[if (mso)|(IE)]></td><td style='padding-top:0px;padding-bottom:0px' width='16' bgcolor='#05C46B'><table role='presentation' width='16' cellpadding='0' cellspacing='0' border='0'><tr><td>&nbsp;</td></tr></table></td></tr></table><![endif]-->
                        ...
                        <div class="col_cont" style="width: 100% !important">
                          ...
                          <div
                            style="
                              ...
                              border-left: 16px solid #05c46b;
                              border-bottom: 16px solid #05c46b;
                              border-right: 16px solid #05c46b;
                              padding-top: 5px;
                              padding-bottom: 5px;
                              padding-right: 0px;
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <p
                                  ...
                                  "
                                >
                                  <span style="font-size: 14px">کاربر گرامی کولینک،</span>
                                </p>
                                <p
                                  dir="rtl"
                                  style="
                                  ...
                                  "
                                >
                                  <span style="font-size: 14px">از اینکه به جمع ما اضافه شدین بسیار خوشحالیم و به خود می بالیم :)</span>
                                </p>
                                <p
                                  dir="rtl"
                                  style="
                                ...
                                >
                                  <span style="font-size: 14px"
                                    >این ایمیل جهت تایید حساب کاربری شما در کولینک ارسال شده است. شما با فعال سازی حساب خود می توانید از تمامی امکانات
                                    کولینک به رایگان استفاده کنید. برای فعال سازی بر روی دکمه زیر کلیک کنید!</span
                                  >
                                </p>
                              </div>
                            </div>
                            ...
                            <div
                              ...
                              style="padding-top: 0px; padding-right: 16px; padding-bottom: 0px; padding-left: 16px"
                            >
                              ...
                              [endif]--><a
                                href="https://coolink.ir/confirm/${token}"
                                style="
                                  ...
                                  width: 100%;
                                  width: calc(100% - 2px);
                                  border-top: 1px solid #05c46b;
                                  border-right: 1px solid #05c46b;
                                  border-bottom: 1px solid #05c46b;
                                  border-left: 1px solid #05c46b;
                                  padding-top: 4px;
                                  padding-bottom: 4px;
                                  font-family: Tahoma, Verdana, Segoe, sans-serif;
                                  text-align: center;
                                ...
                                "
                                target="_blank"
                                ><span style="padding-left: 4px; padding-right: 4px; font-size: 16px; display: inline-block; letter-spacing: undefined"
                                  ><span style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px"
                                    ><strong>فعالسازی حساب کاربری</strong></span
                                  ></span
                                ></a
                              >
                              ...
                              >
                                ...
                                >
                                  <span style="font-size: 12px"
                                    >در صورتی که درخواست ساخت حساب کاربری از سمت شما داده نشده است، این ایمیل را نادیده بگیرید.</span
                                  >
                                </p>
                              </div>
                            </div>
                            ...
                            >
                              ...
                              >
                                <p
                                  ...
                                  "
                                >
                                  <span style="font-size: 12px"><strong>با سپاس تیم کولینک</strong></span>
                                </p>
                              </div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
